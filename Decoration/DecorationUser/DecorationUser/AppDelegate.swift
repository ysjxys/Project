...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let homeNavTabBarItem = UITabBarItem(title: "首页", image: nil, selectedImage: nil)
        ...
        homeNavTabBarItem.setTitleTextAttributes([NSAttributedStringKey.foregroundColor: ColorFromHex("9397a1"), NSAttributedStringKey.font: FontR(UIScale(12))], for: .selected)
        ...
        let shoppingNavTabBarItem = UITabBarItem(title: "商城", image: nil, selectedImage: nil)
        ...
        shoppingNavTabBarItem.setTitleTextAttributes([NSAttributedStringKey.foregroundColor: ColorFromHex("9397a1"), NSAttributedStringKey.font: FontR(UIScale(12))], for: .selected)
        ...
        let personNavTabBarItem = UITabBarItem(title: "我的", image: nil, selectedImage: nil)
        ...
        personNavTabBarItem.setTitleTextAttributes([NSAttributedStringKey.foregroundColor: ColorFromHex("9397a1"), NSAttributedStringKey.font: FontR(UIScale(12))], for: .selected)
...
//        tabBar.tabBar.backgroundImage = UIImage.fromColor(BlueColor)
...
//        userManager.userToken = "1234567890"
//        userManager.userName = "yushengjie"
//        userManager.userPassWord = "password"
//        userManager.userId = "900628"
//        userManager.userPhone = "15067199246"
//        saveModel(userManager, forKey: UserManagerKey)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "DecorationUser")
