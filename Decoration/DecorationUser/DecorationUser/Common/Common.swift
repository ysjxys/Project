...
public let HeightSystemStatus: CGFloat = UIApplication.shared.statusBarFrame.height
public let HeightTabBar: CGFloat = UIApplication.shared.statusBarFrame.height > 20 ? 83 : 49

public let HeightBottomSafeArea: CGFloat = UIApplication.shared.statusBarFrame.height > 20 ? 34 : 0
public let HeightTopSafeArea: CGFloat = UIApplication.shared.statusBarFrame.height > 20 ? 44 : 0

public let HeightNavBarDistance = HeightSystemStatus + HeightNavBar
...
public func ColorFromRGB (red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat = 1) -> UIColor {
