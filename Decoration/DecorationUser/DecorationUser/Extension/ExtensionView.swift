...
extension UIView {
    ...
    private func generateLineView(color: UIColor, for superView: UIView) -> UIView {
        let lineView = UIView()
    ...
    public func addTopLine(borderWidth: CGFloat = CGFloat(1), color: UIColor) {
    ...
    public func addLeftLine(borderWidth: CGFloat = CGFloat(1), color: UIColor) {
        let lineView = generateLineView(color: color, for: self)
        lineView.snp.makeConstraints { (make) in
            make.left.equalTo(self)
