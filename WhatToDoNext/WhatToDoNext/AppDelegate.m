...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    YSJNavigationController *eatNav = [[YSJNavigationController alloc]initWithRootViewController:eatVC];
    
//    YSJTabBarController *tab = [[YSJTabBarController alloc]init];
//    
//    tab.viewControllers = @[eatNav];
    self.window.rootViewController = eatNav;
