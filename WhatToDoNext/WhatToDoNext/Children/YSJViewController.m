 ...
 *  任意控制器的提示title
 */
+ (void)showHudWithTarget:(id)target title:(NSString *)title lastTime:(double)lastTime {
...
- (void)showHudWithTitle:(NSString *)title {
    [YSJViewController showHudWithTarget:self title:title lastTime:1.5f];
}

/**
 *  提示title
 */
- (void)showHudWithTitle:(NSString *)title lastTime:(double)lastTime {
    [YSJViewController showHudWithTarget:self title:title lastTime:lastTime];
}
